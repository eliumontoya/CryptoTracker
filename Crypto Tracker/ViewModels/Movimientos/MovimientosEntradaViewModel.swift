// MovimientoEntradaViewModel.swift
import Foundation
import SwiftData
import Combine

@MainActor
final class MovimientoEntradaViewModel: MovimientoViewModel {
    ...
    init(modelContext: ModelContext, movimiento: MovimientoIngreso? = nil) {
